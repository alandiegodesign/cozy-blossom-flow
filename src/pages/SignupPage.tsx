    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: 'var(--gradient-bg)' }}>
      ...
      >
        <div className="mb-6 flex flex-col items-center">
          ...
          <h1 className="font-display font-bold text-3xl text-foreground">Criar Conta</h1>
          <p className="text-muted-foreground mt-1">Junte-se ao TicketVibe</p>
        </div>
        ...
        <p className="mt-8 text-muted-foreground text-sm">
          Já tem uma conta?{' '}
          <Link to="/login" className="text-foreground font-semibold underline hover:no-underline">
            Entrar
          </Link>
        </p>
      </motion.div>
